...
import com.herenit.arms.integration.ManifestParser;
 ...
 * ConfigModule 的实现类可以有无数多个, 在 Application 中只是注册回调, 并不会影响性能 (多个 ConfigModule 在多 ModuleManager 环境下尤为受用)
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(ApiManager.baseUrl())
